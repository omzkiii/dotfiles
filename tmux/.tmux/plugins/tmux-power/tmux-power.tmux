...
tmux_set status-fg "colour7"
tmux_set status-bg "colour0"
...
tmux_set status-left-fg "$BG"
tmux_set status-left-length 150
user=$(whoami)
LS="#[fg=$BG,bg=colour12,bold] $session_icon #S "
# LS="#[fg=color0,bg=colour12,bold] $session_icon #{b:pane_current_path}"
...
if "$show_upload_speed"; then
    ...
    LS="$LS#[fg=colour12,bg=$BG]$rarrow"
fi
...
RS="#[fg=colour9]$larrow#[fg=colour0,bg=colour9] $time_icon $time_format #[fg=$TC,bg=colour0]"
...
tmux_set window-status-format "#[fg=$BG,bg=colour8]$rarrow#[fg=$TC,bg=colour8]#I:#W#F #[fg=colour8,bg=$BG]$rarrow"
